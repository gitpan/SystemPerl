#$Revision: 1.33 $$Date: 2005-03-17 11:21:50 -0500 (Thu, 17 Mar 2005) $$Author: wsnyder $
######################################################################
#
...
=item SP_TEMPLATE ("<instregexp>", "<portregexp>", "<netregexp>");
...
AUTOCTOR creates signal and port name initializers for SC_CTOR's.
...
For example:
    ...
    SC_MODULE(mod) {
	SC_CTOR(mod) /*AUTOCTOR*/ {

Becomes:

    SC_MODULE(mod) {
	SC_CTOR(mod)
	      // Beginning of SystemPerl automatic constructor
	      : clk("clk")
	      // End of SystemPerl automatic constructor
