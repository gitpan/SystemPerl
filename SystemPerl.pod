#$Revision: #25 $$Date: 2002/12/13 $$Author: lab $
######################################################################
#
...
replaces __DOT__ in signal names to "." to support fake hiearchy, such as
...
In addition to specifing an exact string like with #include, you may also
specify a define symbol.  The value of the definition will be used as the
file to be included.
